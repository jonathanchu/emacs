;;; oceanic-eighties-theme.el --- Oceanic Eighties Theme
;;
...
(deftheme oceanic-eighties
  "Oceanic Eighties color theme")

(custom-theme-set-faces
 'oceanic-eighties
 '(default (( t (:background "#1b2630" :foreground "#cccccc"))))  ;; DONE
 '(cursor ((t (:background "#e19938"))))  ;; DONE
 '(border ((t (:foreground "#ffffff"))))
 ;; '(region ((t (:background "#6c91be"))))
 '(region ((t (:background "#1b5e78"))))  ;; DONE
 '(fringe ((t (:background "#1b2630"))))  ;; DONE
 ...
 '(font-lock-constant-face ((t (:foreground "#99cc99"))))  ;; DONE
 '(font-lock-doc-face ((t (:foreground "#99cc99"))))  ;; DONE
 '(font-lock-doc-string-face ((t (:foreground "#a8ff60"))))  ;; DONE
 '(font-lock-comment-face ((t (:foreground "#7c7c7c"))))  ;; DONE
 '(font-lock-function-name-face ((t (:foreground "#6699cc"))))  ;; DONE
 '(font-lock-keyword-face ((t (:foreground "#cc99cc"))))  ;; DONE
 '(font-lock-string-face ((t (:foreground "#a8ff60"))))  ;; DONE
 '(font-lock-type-face ((t (:foreground "#ffd2a7"))))  ;; DONE
 '(font-lock-variable-name-face ((t (:foreground "#f2777a"))))  ;; DONE
...
(provide-theme 'oceanic-eighties)
;;; oceanic-eighties-theme.el ends here
